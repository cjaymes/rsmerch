...
c.execute('''CREATE TABLE "item" ( `id` INTEGER NOT NULL, `name` TEXT NOT NULL, `description` TEXT NOT NULL, `icon` TEXT NOT NULL, `icon_large` TEXT NOT NULL, `category` INTEGER NOT NULL, `members` BOOLEAN NOT NULL, `current_price` INTEGER NOT NULL, PRIMARY KEY(`id`) )''')
